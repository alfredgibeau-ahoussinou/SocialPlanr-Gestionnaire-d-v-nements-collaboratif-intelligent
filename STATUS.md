...
- ✅ **Authentification Firebase** : Inscription, connexion, déconnexion sécurisées (v12 corrigée)
- ✅ **Google OAuth** : Inscription/connexion Google intégrée avec gestion erreurs complète
