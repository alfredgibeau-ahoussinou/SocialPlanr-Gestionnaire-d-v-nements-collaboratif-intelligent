...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section avec image de fond qui couvre tout */}
      <section className="relative min-h-screen flex flex-col px-4 sm:px-6 lg:px-8 overflow-hidden">
        {/* Background image qui couvre toute la section y compris le header */}
        <div 
      ...
      {/* Header */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden md:flex space-x-8">
                ...
                <a href="/install" className="text-white hover:text-blue-200 transition-colors drop-shadow-lg font-medium">
                📱 Installer l&apos;app
              </a>
        ...
        <div className="flex-1 flex items-center justify-center">
          ...
          >
            ...
            <a href="/install" className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-10 py-5 rounded-2xl text-xl font-bold hover:shadow-2xl transition-all duration-300 transform hover:scale-110 inline-block text-center min-w-[250px] shadow-lg">
              📱 Installer l&apos;app
            </a>
          </motion.div>
          </div>
